...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <form action="{{ route('passwordupdate') }}" method="POST" id="commentForm" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <input type="password" class="mt-3 form-control" placeholder="Confirm Password" required
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img class="img-account-profile rounded-circle mb-2"
                        src="{{ Storage::url(Auth::user()->profilepic) }}" alt="">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control disable" id="inputEmailAddress" type="email"
