<x-admin-layout>
    ...
    <div class="p-12">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('admin.property.update', $property->id) }}"
            id="commentForm">
            @csrf
            @method('PUT')
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="price" id="price"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{ $property->price }}">
                <label for="price"
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="floor_area" id="floor_area"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{ $property->floor_area }}">
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <input type="number" name="bedroom" id="bedroom"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required="" value="{{ $property->bedroom }}">
                    <label for="bedroom"
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="number" name="bathroom" id="bathroom"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required="" value="{{ $property->bathroom }}">
                    <label for="bathroom"
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="address"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{ $property->address }}">
                <label for="address"
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="description"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{ $property->description }}">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="near_by_places"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required="" value="{{ $property->near_by_places }}">
            ...
            <select id="city" name="city"
                ...
                @foreach ($cities as $city)
                    <option value="{{ $city->name }}" @if ($property->city == $city->name) selected @endif>
                        {{ $city->name }}</option>
                @endforeach
            </select>
            ...
            <button
                ...
                type="button" data-modal-toggle="Modal">
                View Default Image
            </button>
    ...
    <div id="Modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <img src="{{ Storage::url($property->default_image) }}" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                @if (isset($property->images[0]))
                    <img src="{{ Storage::url($property->images[0]->url) }}" alt="">
                @endif
            </div>
        </div>
    </div>
    ...
    <div id="Modal2" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                @if (isset($property->images[1]))
                    <img src="{{ Storage::url($property->images[1]->url) }}" alt="">
                @endif
            </div>
        </div>
    </div>
    ...
    <div id="Modal3" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                @if (isset($property->images[2]))
                    <img src="{{ Storage::url($property->images[2]->url) }}" alt="">
                @endif
    ...
    <div id="Modal4" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                @if (isset($property->images[3]))
                    <img src="{{ Storage::url($property->images[3]->url) }}" alt="">
                @endif
            </div>
        </div>
    </div>
